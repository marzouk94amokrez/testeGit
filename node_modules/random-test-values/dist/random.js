...
var Random = /** @class */ (function () {
    ...
    Random.PrimativeArray = function (example, length) {
        ...
        if (typeof example == "string") {
            var results = [];
            for (var i = 0; i < length; i++) {
                results.push(this.String());
            }
            return results;
        }
        throw new Error("Invalid primative type");
    };
    Random.populateProperties = function (stuff) {
        var result = stuff;
            ...
            if (Object.getOwnPropertyDescriptor(result, properties[i]).writable == true) {
                switch (propertyType) {
                    ...
                    case "string":
                        ...
                        break;
                    default:
                        result[properties[i]] = this.populateProperties(result[properties[i]]);
                        break;
                }
            }
        }
    ...
    Random.Object = function (typeData) {
        ...
        result = this.populateProperties(result);
        return result;
    };
    return Random;
}());
