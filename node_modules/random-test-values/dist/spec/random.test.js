...
var NestedTestClass = /** @class */ (function () {
    function NestedTestClass() {
...
describe("Random Library - Primative Array", function () {
    it("Should work with non-object Random Numbers", function () {
        var result = random_1.Random.PrimativeArray(0, 5);
        Assert.typeOf(result[0], "number");
    });
    it("Should work with non-object Random Booleans", function () {
        var result = random_1.Random.PrimativeArray(true, 5);
        Assert.typeOf(result[0], "boolean");
    });
    it("Should work with non-object Random Strings", function () {
        var result = random_1.Random.PrimativeArray("", 5);
        Assert.typeOf(result[0], "string");
    });
});
describe("Random Library - Nested Object", function () {
    it("Should generate a random number in the nested class", function () {
        var result = random_1.Random.Object(NestedTestClass);
        Assert.isNotNull(result.testClass.testNumber);
        Assert.notEqual(result.testClass.testNumber, undefined);
    });
    it("Should generate a random string in the nested class", function () {
        var result = random_1.Random.Object(NestedTestClass);
        Assert.isNotNull(result.testClass.testString);
        Assert.isNotEmpty(result.testClass.testString);
        Assert.notEqual(result.testClass.testString, undefined);
    });
    it("Should generate a random boolean in the nested class", function () {
        var result = random_1.Random.Object(NestedTestClass);
        Assert.isNotNull(result.testClass.testBoolean);
        Assert.notEqual(result.testClass.testBoolean, undefined);
    });
});
